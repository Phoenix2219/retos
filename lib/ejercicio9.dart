...
class _Ejercicio9 extends State<Ejercicio9> {
  ...
  void _calcularsemana() {                        
    setState(() {
      ...
      switch(numero){
        case 1: _semana = "Lunes"; break;
        case 2: _semana = "Martes"; break;
        case 3: _semana = "Miercoles"; break;
        case 4: _semana = "Jueves"; break;
        case 5: _semana = "Viernes"; break;
        case 6: _semana = "Sabado"; break;
        case 7: _semana = "Domingo"; break;
        default: _semana = "No existe"; break;
      }
    }); 
  }
